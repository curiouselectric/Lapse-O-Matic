        ...
        if (data_valid == true)
        {
          ...
          switch (setting_number)
          {
            ...
            case 10:
              ...
              break;
            case 11:
              _settings_config.USER_EMAIL  = outputString;
              Serial.println(_settings_config.USER_EMAIL);
              break;
            case 12:
              _settings_config.USER_PASSWORD  = outputString;
              Serial.println(_settings_config.USER_PASSWORD);
              break;
            case 13:
              _settings_config.API_KEY = outputString;
              Serial.println(_settings_config.API_KEY);
              break;
            case 14:
              _settings_config.STORAGE_BUCKET_ID = outputString;
              Serial.println(_settings_config.STORAGE_BUCKET_ID);
              break;
            case 15:
